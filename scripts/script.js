  ...
  fetch(url)
    ...
    .then(entries => {
      entries.forEach((entry) => {
        ...
        // CODE GOES HERE vvv
        const indexElement = document.querySelector("main");
        const newSource = document.createElement("journal-entry");
        newSource.entry = entry;
        indexElement.appendChild(newSource);
